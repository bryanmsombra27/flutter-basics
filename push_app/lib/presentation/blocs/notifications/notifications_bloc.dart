...
class NotificationsBloc extends Bloc<NotificationsEvent, NotificationsState> {
  ...
  static Future<void> firebaseIniNotificationFCM() async {
    await Firebase.initializeApp(
  ...
  PushMessage? getMessageById(String id) {
    final exits =
        state.notifications.any((notification) => notification.messageId == id);

    return exits
        ? state.notifications
            .firstWhere((notification) => notification.messageId == id)
        : null;
  }
